...
- Anyone with no GS is now re-inspected automatically until a scan actually lands, including rows left blank by the bug above, so they fill in by themselves once the player comes back into range. Players who scanned successfully are still never re-scanned.
