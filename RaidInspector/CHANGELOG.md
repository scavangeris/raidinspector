...
- The test harness now lives in the repo at `tools/test/` (`python tools/test/run.py`) instead of a temp folder: it compile-checks every addon file under Lua 5.1 and drives the real addon through 150+ checks against a stubbed WoW API.
